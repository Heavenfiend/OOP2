      ...
      if (c < '0' || c > '4')
        {
          throw std::invalid_argument (
              "Неверная цифра в числе в пятиричной системе");
        }
    }
...
{
  return Five (other); // Явное присваивание через конструктор копирования
}

bool
Five::equals (const Five &other) const
{
  return digits == other.digits;
}

bool
Five::less (const Five &other) const
{
...
bool
Five::greater (const Five &other) const
{
...
unsigned char
Five::getDigit (size_t index) const
{
